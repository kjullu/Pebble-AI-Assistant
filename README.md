...
- `Routing priority`: lets OpenRouter use its automatic routing or order provider endpoints by lowest price, highest generation throughput, or lowest response latency.
